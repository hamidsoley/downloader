...
|----------|-------|
| **File** | `psiphon3.exe` |
| **URL** | https://files.bokhary.ir/logique/pub/Clients/psiphon3.exe |
| **Date** | 2026-05-10 00:47:33 UTC |
| **Status** | **FAILED** |
...
```
Download failed after 3 attempts. Last error: #=#=#                                                                          curl: (6) Could not resolve host: files.bokhary.ir
